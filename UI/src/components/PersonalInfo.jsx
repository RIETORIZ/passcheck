    ...
    <section className="card span-2">
      <details>
        ...
        <div className="form-grid" style={{ marginTop:'1rem' }}>
          <label>Full Name
            <input name="full_name" value={info.full_name} onChange={onChange} />
          </label>
          <label>Email
          ...
          <label>Location
            <input name="location" value={info.location} onChange={onChange} />
          </label>
          <label>Address
            <input name="address" value={info.address} onChange={onChange} />
          </label>
          <label>Birthday
            <input type="date" name="dob" value={info.dob} onChange={onChange} />
          </label>
        </div>
      </details>
    </section>
