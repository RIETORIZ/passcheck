    ...
    <div style={{ position:'relative', minHeight:'100vh' }}>
      ...
      <header className="topbar">
        <div className="container">
          <div className="brand">PassCheck</div>
        </div>
      </header>
      ...
      <footer className="footer" style={{ position:'relative', zIndex:1 }}>
        <div className="container row between center">
          ...
          <div className="muted small">Endpoints: <code>/analyze_password</code> · <code>/generate_password</code> · <code>/crack_password_stream/&lt;pwd&gt;</code></div>
        </div>
      </footer>
    </div>
  )
